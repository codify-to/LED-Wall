...
void main (void)
{
	...
	INTCONbits.GIEH=0;		//Habilita as interrupções de alta prioridade
	INTCONbits.GIEL=0;		//Habilita as interrupções de baixa prioridade
	...
	PIE1bits.SSP1IE = 0;	//Habilita a interrupção
