//----------------------------- M�dulo para Displays LCD --------------------------------//

#include<delays.h> //Biblioteca necess�ria para gerar o delay

//----------------------------- Configura��o de Hardware -------------------------------//

//Pinos do LCD

#define Fr_Mhz 8 //Velocidade do Microcontrolador: 48, 40, 20, 16 e 12 Mhz. 
...
{
	RS = cmd_data; //Informa se � um comando ou dado.
    ...
    tempo_us(delay); //Delay necess�rio para comando enviado
}
...
//Inicializa o LCD. Configura��o padr�o:
